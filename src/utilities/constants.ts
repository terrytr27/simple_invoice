...
export const APP_URLS = {
  BASE_URL: 'https://api-wso2-101digital-sandbox.101digital.io/',
  GET_TOKEN: 'oauth2/token',
  GET_PROFILE:
    'https://api-wso2-101digital-sandbox.101digital.io/membership-service/1.0.0/users/me',
  GET_INVOICES_LIST:
    'https://api-wso2-101digital-sandbox.101digital.io/invoice-service/1.0.0/invoices',
};
